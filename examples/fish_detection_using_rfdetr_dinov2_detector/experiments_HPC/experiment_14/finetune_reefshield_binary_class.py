...
The pretrained model is from experiment_12/checkpoint0029.weights.h5, where the RF-DETR Large model is pretrained on the 
merged dataset of DeepFosh & Fathom dataset for sea_animal detection (binary classfication)
