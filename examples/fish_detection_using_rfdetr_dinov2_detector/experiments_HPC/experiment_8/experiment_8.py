#!/usr/bin/env python
"""Experiment 8: RF-DETR Nano — native RF-DETR augmentation benchmark.
...
def main():
    ...
    logger.info("=" * 68)
    logger.info("EXPERIMENT 8: RF-DETR Nano — Native RF-DETR Augmentation")
    logger.info("=" * 68)
    ...
    exp_config = {
        ...
        "description": (
            "RF-DETR Nano with native RF-DETR augmentation "
