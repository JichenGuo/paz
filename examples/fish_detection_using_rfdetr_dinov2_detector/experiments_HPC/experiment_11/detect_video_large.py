#!/usr/bin/env python
"""Run RF-DETR Large  detection on a video and save an annotated video."""
...
from detect_image_large import (  # noqa: E402
    DEFAULT_CHECKPOINT,
...
def parse_args():
    parser = argparse.ArgumentParser(
        description=(
            "Load an Experiment 11 or fine-tuned RF-DETR Large checkpoint, "
